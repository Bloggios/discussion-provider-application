...
package com.bloggios.discussion.configuration;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.bloggios.discussion.dao.repository.elasticsearch")
@ComponentScan(basePackages = "com.bloggios.discussion")
